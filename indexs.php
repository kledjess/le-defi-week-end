            ...
            <div class="row">
                <div class="col-lg-10 col-lg-offset-1">
                    <form id="contact-form" method="post" action="" role="form">
                        <div class="row">
                            <div class="col-md-6">
                                <label for="firstname">Prénoms<span class="blue"> *</span></label>
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea id="Message" required name="Message" class="form-control" placeholder="votre Message" rows="4"></textarea>
                                <p class="comments"></p>
                            </div>
